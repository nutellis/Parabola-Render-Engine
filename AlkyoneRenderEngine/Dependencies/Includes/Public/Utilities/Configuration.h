...
public:
	...
	Value(Value && MoveValue) noexcept : Key(MoveValue.Key), Content(MoveValue.Content) {}
	...
	Value & operator=(Value && MoveValue) noexcept
	{
		if (this != &MoveValue) {
...
public:
	...
	Section(Section && MoveSection) noexcept: SectionName(MoveSection.SectionName), Values(MoveSection.Values) {}
	...
	Section & operator=(Section && Move) noexcept {
