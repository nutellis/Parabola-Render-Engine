...
{
	pos = VertexBufferObject();
	col = VertexBufferObject();
}
...
/*
void  VertexArrayObject::CreateBuffer(const void *Data = nullptr)
{
	// Create the buffer
...
void VertexArrayObject::SetupArray(uint32 BufferIndex, uint32 Attribute, uint32 RelativeOffset)
{
...
void VertexArrayObject::BindBuffer(uint32 Buffer,uint32 Index,uint32 Stride)
{
...
void  VertexBufferObject::CreateBuffer(int32 Size , const void *Data = nullptr)
{
	// Create the buffer
	glCreateBuffers(1, &ID);
...
void VertexBufferObject::CopyBuffer(uint32 ReadBufferID, intptr ReadOffset)
{
